...
function shell({ preheader, eyebrow, heading, bodyHtml, headerBg = "#ffffff" }) {
  return `<!doctype html>
<html lang="de">
<head>
<meta charset="utf-8">
    ...
    <tr><td align="center">
      <table role="presentation" width="100%" cellpadding="0" cellspacing="0" class="card" style="max-width:560px;background:#ffffff;border-radius:14px;overflow:hidden;box-shadow:0 6px 24px rgba(90,26,26,0.10)">
        <tr><td class="hpad" style="background:${headerBg};padding:26px 36px 20px;text-align:center">
          <img src="${ASSET_BASE}/images/odysseus-schiff-logo.png" width="180" alt="Restaurant Odysseus" class="logo" style="display:inline-block;width:180px;max-width:62%;height:auto">
          <div style="font-size:11px;letter-spacing:0.24em;color:${C.bordeaux};text-transform:uppercase;margin-top:6px">${eyebrow}</div>
        </td></tr>
